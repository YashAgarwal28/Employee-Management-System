...
def Display_Employ():
    print("{:>50}".format("-->> Display Employee Record <<--"))
...
def Promote_Employ():
    print("{:>60}".format("-->> Promote Employee Salary Record <<--\n"))
    Id = input("Enter Employee Id: ")
    # checking If Employee Id is Exit Or Not
    if (check_employee(Id) == False):
        print("Employee Record Not exists\nTry Again")
...
def Promote_Post():
    print("{:>60}".format("-->> Promote Employee Post Record <<--\n"))
    Id = input("Enter Employee Id: ")
    # checking If Employee Id is Exit Or Not
    if (check_employee(Id) == False):
        print("Employee Record Not exists\nTry Again")
        ...
        for i in r:
            ...
            print("Employee Salary: ", i[6])
            print("\n")
        Post = input("Enter Employee New Post: ")
...
def menu():
    ...
    print("4. Promote Employee Salary Record")
    print("5. Promote Employee Post Record")
    print("6. Remove Employee Record")
    print("7. Search Employee Record")
    print("8. Exit\n")
